...
browser = webdriver.Chrome('C:/Users/Azerates/Downloads/chromedriver.exe')
browser.get(url)
# User-Agent를 통해 봇이 아닌 유저정보라는 것을 위해 사용
header = {
    'User-Agent': "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.134 Safari/537.36"}

#이 부분은 수정하시길 바랍니다. 개인화된 값은 Chrome 브라우저를 열고 chrome://version을 입력하면 온갖 정보들이 나오는데, 이중에서 사용자 에이전트 값을 입력합니다.
